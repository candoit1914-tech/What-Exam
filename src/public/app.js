...
async function pdfUploadForm(id) {
  const div = await openModal('Upload Exam PDF', `
    <p class="muted" style="margin-bottom:12px">Upload any PDF — text-based or scanned. Answer keys and options are detected automatically; missing answers are generated by AI. Diagrams and images are extracted and sent with the questions.</p>
